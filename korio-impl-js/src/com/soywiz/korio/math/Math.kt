...
impl object Math {
	...
	impl fun ceil(v: Double): Double = JMath.ceil(v).toDouble()
	impl fun floor(v: Double): Double = JMath.floor(v).toDouble()
	impl fun round(v: Double): Long = JMath.round(v).toLong()
}