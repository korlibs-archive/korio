...
fun <T> Array<T>.copyRangeTo(srcPos: Int, dst: Array<T>, dstPos: Int, count: Int): Unit = Arrays.copyRangeTo(this, srcPos, dst, dstPos, count)
fun BooleanArray.copyRangeTo(srcPos: Int, dst: BooleanArray, dstPos: Int, count: Int): Unit = Arrays.copyRangeTo(this, srcPos, dst, dstPos, count)
...
fun <T> Array<T>.fill(value: T, from: Int = 0, to: Int = this.size): Unit = Arrays.fill(this, value, from, to)
