...
class DynamoDBTest {
	...
	fun customEndPoint() = syncTest {
		...
		val db = DynamoDB("eu-west-1", endpoint = URL("http://127.0.0.1:8000"), accessKey = "testAccessKey", secretKey = "testSecretKey", timeProvider = timeProvider, httpClient = httpClient)
