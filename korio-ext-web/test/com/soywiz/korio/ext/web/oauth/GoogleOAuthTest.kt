...
class GoogleOAuthTest {
	...
	val oauth = GoogleOAuth(clientId = "myclient", clientSecret = "mysecret", client = client, redirectUri = "https://myredir")
	...
	fun testGetTokenId() = syncTest {
		assertEquals(
			...
			client.capture {
				...
				assertEquals("mytoken", oauth.getTokenId("mycode"))
			}
		)
	}
